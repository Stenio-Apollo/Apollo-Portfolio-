...
const ContactSection = () => {
  ...
  return (
    ...
    >
        ...
        <div
            ref={circleRef}
            className="w-24 sm:w-28 md:w-32 h-24 sm:h-28 md:h-32 rounded-full flex items-center justify-center relative transition-shadow duration-1000 shadow-rose-50 shadow-lg bg-gradient-to-r from-stone-100 to-rose-100"
        >
            {/* initial Text */}
            <p
                ref={initialTextRef}
                className="ClassicoBold text-black font-bold text-base sm:text-lg md:text-xl absolute inset-0 flex items-center text-center"
            >
                SCROLL DOWN
            </p>
            ...
            >
                ...
                <h1 className="ClassicoBold text-black md:w-[10rem] w-[10rem] lg:scale-[0.4] sm:scale-[0.25] scale-[0.07] md:font-bold text-sm sm:text-base leading-none mb-5">
                    Deploy With Rhodie
                </h1>

                <p className=" text-gray-800 lg:w-[40rem] w-[20rem] absolute sm:mt-3 mt-1 md:scale-[0.1] scale-[0.068]">
                      Front-end developer specialized in crafting modern, responsive web interfaces using React, Tailwind CSS, Spline, NextJs, and advanced UI animation techniques. Projects consist of clean
