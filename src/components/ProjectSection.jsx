  ...
  const projectImages = [
    {
      id: 1,
      title: "ProjectBuild",
      imageSrc: "/images/Station7.png",
    },
    {
      id: 2,
      title: "RhodieApp",
      imageSrc: "/images/RhodieApp.png",
    },
    {
      id: 3,
      title: "ProjectBuild2",
      imageSrc: "/images/Webbuild.png",
    },
  ];
  useEffect(() => {
    ...
    // Parallax affect for the entire section
    gsap.fromTo(
      sectionRef.current,
      {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 mb-16 relative z-10">
        <h2
          ref={titleRef}
          className="Classico text-4xl md:text-5xl lg:text-6xl font-bold
      ...
      <div ref={triggerRef} className="overflow-hidden">
        ...
        >
          {projectImages.map((project) => (
            ...
            justify-center p-4 sm:p-8 md:p-12"
            >
              <div
              ...
              >
                ...
                md:text-3xl text-sm md:font-bold text-white mt-6
